 ...
 * @author jmanu
 */
public class HandsanitizerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       Query q1 = sesi.createQuery("from Handsanatizer");
   
       List<Handsanatizer> lkasus = q1.list();
        sesi.close();
        ...
        isi.setText(lkasus.get(0).getIsi());
         simpan.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent event) {
                Session sesi = Connection.getSessionFactory().openSession();
                Handsanatizer newdata = lkasus.get(0);
