 ...
 * @author jmanu
 */
public class GejalaInfeksiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       Query q1 = sesi.createQuery("from Gejalaterinfeksi");
   
       List<Gejalaterinfeksi> lkasus = q1.list();
        sesi.close();
        ...
        isi.setText(lkasus.get(0).getIsi());
         simpan.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent event) {
                Session sesi = Connection.getSessionFactory().openSession();
                Gejalaterinfeksi newdata = lkasus.get(0);
