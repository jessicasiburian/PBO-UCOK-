 ...
 * @author jmanu
 */
public class PenanganController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       Query q1 = sesi.createQuery("from Penangan");
   
       List<Penangan> lkasus = q1.list();
        sesi.close();
